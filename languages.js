...
const translations = {
    'zh': {
        ...
        'news.featured.content': '经过数月的精心设计和反复打磨，islandJQ DESIGN STUDIO 全新的视觉识别系统正式发布。新的品牌形象更好地体现了我们简约现代的设计理念，以及对细节的极致追求。从标志设计到色彩系统，每一个细节都经过精心考量，旨在为客户提供更加专业和一致的品牌体验。',
        'news.readMore': '阅读更多',
