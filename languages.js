...
const translations = {
    'zh': {
        ...
        'works.subtitle': '精选作品',
        'works.filter.all': '全部',
        'works.filter.branding': '品牌设计',
        'works.filter.print': '印刷作品',
        'works.filter.digital': '数字设计',
        'works.filter.illustration': '插画设计',
        'works.filter.packaging': '包装设计',
        'works.filter.web': '网页设计',
        'works.filter.photography': '摄影作品',
    ...
    'en': {
        ...
        'works.filter.branding': 'Branding',
        'works.filter.print': 'Print',
        'works.filter.digital': 'Digital',
        'works.filter.illustration': 'Illustration',
        'works.filter.packaging': 'Packaging',
